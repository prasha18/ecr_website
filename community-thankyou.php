...
<head>
	...
	<meta name="description" content='Discover gratitude on our Thank You page. Join us in celebrating moments of connection and spreading positivity. Thank you for being part of our journey!'>
	<meta name="keywords"
		content="Thank you, Thank you LetsFame">
	<meta name="author" content="Ajmal">
	<meta name="p:domain_verify" content="97108a573ee57d532fae349647673743" />
	<title>LetsFame - Thank you </title>
	<link rel="shortcut icon" href="assets/img/favicon.ico">
	<!-- Style CSS Start -->
	<meta property='og:title' content="LetsFame - Thank you" />
	<meta property='og:image' content='' />
	<meta name="robots" content="index, follow" />
	<meta property='og:description' content='Discover gratitude on our Thank You page. Join us in celebrating moments of connection and spreading positivity. Thank you for being part of our journey!' />
	<meta property='og:url' content='https://www.letsfame.com/thankyou' />
	<meta property="og:image:type" content="image/png">
	<meta property="og:image:width" content="1024">
	<meta property="og:image:height" content="1024">
	<meta property="og:type" content='website' />
	<link rel="canonical" href="https://www.letsfame.com/thankyou">
	<link rel="alternate" href="https://www.letsfame.com/thankyou" hreflang="en-us">
...
<body>
	...
	<noscript>
		<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5M4KV6W" height="0" width="0" style="display:none;visibility:hidden"></iframe>
	</noscript>
                                            ...
                                            <div class="bg-dark shadow-sm">
                                                <div class="row">
                                                    <div class="col-md-4 mob-form-image">
                                                        <img src="assets/img/qr-code-image.png" alt="QR-Code LetsFame" title="QR-Code LetsFame" class="img-fluid bgimg rounded-start">
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="qr-code-popup mt-5">
                                                            <h3 class="text-white">World’s 1st professional networking & talent hiring app for the Entertainment World</h3>
                                                            <div class="my-3 imgwidth pt-5">
                                                                <div class="row">
                                                                    <div class="col-md-7">
                                                                        <h5 class="text-white">Download Our Mobile App to Experience the Full Potential of the Platform</h5>
                                                                        <h6 class="mb-3 text-white">Downloads Available on</h6>
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <a href="https://play.google.com/store/apps/details?id=com.letsfame.app"
                                                                                    target="_blank" class=""><img src="assets/img/android.svg" alt="img" class="img-fluid"></a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-5 pt-3">
                                                                        <img src="assets/img/qr-code.png" alt="QR-Code LetsFame" title="QR-Code LetsFame" class="img-fluid qr-code" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
<!-- ======= Under Construction Start ======= -->
	...
	<div class="container py-5">
		<div class="row">
		<div class="col-md-7 mx-auto border shadow p-3">
		<!-- <h1 class="text-center pt-3 yellow">THANK YOU </h1> -->
		<div class="text-center">
		<img src="assets/img/thankyou.jpg" class="img-fluid w-75">
		</div>
		<p class="text-center">Your registration is complete. One of our team members will contact you soon!</p>
		<div class="mt-1 pb-4" align="center"> 
        <a href="manojkrishna" class="lets-btn py-2 px-4">Go Back to Home Page</a>
        </div>
		</div>
		</div>
	   </div>
