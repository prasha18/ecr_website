...
<head>
	...
	<title>Privacy Policy - LetsFame protected users data by the platform</title>
	<link rel="shortcut icon" href="assets/img/favicon.ico">
	<!-- Style CSS Start -->
	<meta property='og:title' content="Privacy Policy - LetsFame protected users data by the platform"/>
    ...
    <meta property='og:url' content='https://www.letsfame.com/privacy-policy'/> 
	<meta property="og:image:type" content="image/png">
    <meta property="og:image:width" content="1024">
    <meta property="og:image:height" content="1024">
    <meta property="og:type" content='website'/>
    <link rel="canonical" href="https://www.letsfame.com/privacy-policy">
	<link rel="alternate" href="https://www.letsfame.com/privacy-policy" hreflang="en-us">
        ...
        <div class="container py-5">
            <div class="row p-2">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<h5 class="text-start">Subscription Refund Policy</h5>
					<p class="text-justify py-2">If you decide to cancel your subscription and request a refund at any time, please be aware that such requests must be made within a certain timeframe from the subscription purchase date, as specified in our terms and conditions. Upon receiving a valid refund request, we will process it within 5-7 working days. The refund will be credited back to your original method of payment within this timeframe.
					</p>
                    ...
                    <p class="text-justify py-2">If you would like to contact us to understand more about this Policy or
                        ...
                        Information, you may send an email to <a href="mailto:support@letsfame.com"
                            class="text-primary">support@letsfame.com</a></p>
							
							<p class="fw-bold">Or write a letter to : </p>
							<p class="fw-bold">
							Letsfame Technologies Private Limited,<br>
							25, Dr. Radhakrishnan Salai,<br>
							Mylapore, Chennai, TN, 600004.<br>
							Phone No: +91 6369111697
							</p>
							
                       <p>This document was last updated on January 9, 2020.</p>
                </div>
            </div>
        </div>
    </section>
