...
<head>
	...
	<meta name="description"
		content='A policy explaining the use of cookies on a website, including purposes, types, and how users can manage or disable them for privacy preferences.'>
	...
	<title>Cookie Policy - How users can manage data by the privacy preferences.</title>
	<link rel="shortcut icon" href="assets/img/favicon.ico">
	<!-- Style CSS Start -->
	<meta property='og:title' content="Cookie Policy - How users can manage data by the privacy preferences." />
	<meta property='og:image' content='' />
	<meta name="robots" content="index, follow" />
	<meta property='og:description'
		content='A policy explaining the use of cookies on a website, including purposes, types, and how users can manage or disable them for privacy preferences.' />
	<meta property='og:url' content='indexcookie-policy' />
	<meta property="og:image:type" content="image/png">
	<meta property="og:image:width" content="1024">
	<meta property="og:image:height" content="1024">
	<meta property="og:type" content='website' />
	<link rel="canonical" href="indexcookie-policy">
	<link rel="alternate" href="indexcookie-policy" hreflang="en-us">
	...
	<script type="application/ld+json">
		...
		"name": "Cookie Policy - How users can manage data by the privacy preferences.",
		"image": "indexassets/img/logo.png",
		"@id": "cookie policy",
		"url": "indexcookie-policy",
		"telephone": "",
		"address": {
			"@type": "PostalAddress",
	...
	<script>
		$('.skill-list ul li a').click(function (e) {
	...
	<script>
		function myFunction2() {
			var x = document.getElementById("myshowreel");
	...
	<script>
		...
		// 	path: 'assets/img/Animation - 1689918153096.json'
		// })
			...
			<div class="row text-center p-2">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<p class="text-justify py-2">This cookie policy (“Policy”) describes what cookies are and how and
						...
						products and services (collectively, “Services”). This Policy is a legally binding agreement
						between
						you (“User”, “you” or “your”) and LetsFAME Technologies Pvt. Ltd (“LetsFAME Technologies Pvt.
						Ltd”,
						“we”, “us” or “our”). You should read this Policy so you can understand the types of cookies we
						use,
					...
					<p class="text-justify py-2">Cookies are small pieces of data stored in text files that are saved on
						...
						who
						serve content or provide advertising or analytics services on the Website (“third party
						cookies”).
					...
					<p class="text-justify py-2">Necessary cookies allow us to offer you the best possible experience
						when
						accessing and navigating through our Website and using its features. For example, these cookies
						let
					...
					<p class="text-justify py-2">Functionality cookies let us operate the Website and Services in
						accordance
					...
					<p class="text-justify py-2">If you don’t like the idea of cookies or certain types of cookies, you
						can
						change your browser’s settings to delete cookies that have already been set and to not accept
						new
					...
					<p class="text-justify py-2">We reserve the right to modify this Policy or its terms relating to the
						Website and Services at any time, effective upon posting of an updated version of this Policy on
						the
					...
					<p class="text-justify py-2">You acknowledge that you have read this Policy and agree to all its
						terms
					...
					<p class="text-justify py-2">If you would like to contact us to understand more about this Policy or
						wish to contact us concerning any matter relating to our use of cookies, you may send an email
						to <a href="mailto:support@letsfame.com" class="text-rimary">support@letsfame.com</a>
						<br><br>
