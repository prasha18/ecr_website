...
<head>
	...
	content='Explore the Art of Editing with Film Editor PK aka Pon Kathiresh'>
	<meta name="keywords"
	content="PK aka Pon Kathiresh, Art of Editing, Film Editor">
	<meta name="author" content="PK">
	<meta name="p:domain_verify" content="97108a573ee57d532fae349647673743" />
	<title>PK - Kickstart Your Career in Cinema</title>
	<link rel="shortcut icon" href="assets/img/favicon.ico">
	<!-- Style CSS Start -->
	<meta property='og:title'
	content="PK - Kickstart Your Career in Cinema"/>
	<meta property='og:image' content='' />
	<meta name="robots" content="index, follow" />
	<meta property='og:description'
	content='Explore the Art of Editing with Film Editor PK aka Pon Kathiresh 
'/>
	<meta property='og:url' content='https://www.letsfame.com/pk'/>
	<meta property="og:image:type" content="image/png">
	<meta property="og:image:width" content="1024">
	<meta property="og:image:height" content="1024">
	<meta property="og:type" content='website' />
    <link rel="canonical" href="https://www.letsfame.com/pk">
	<link rel="alternate" href="https://www.letsfame.com/pk" hreflang="en-us">
	...
	<link rel="canonical" href="indexads">
	<link rel="alternate" href="indexads" hreflang="en-us">
   ...
   <script>
	...
	<style> 
		...
		#imageapp {
			...
			background-image: url('assets/img/home/bigestcut.webp');
		}
		...
		.new-banner .contentw-100-scroll {
			position: absolute;
			bottom: 3%;
			left: 0;
			margin-right: unset; 
		...
		.iframe-wh{width: 100%;height: 400px;}
...
<div class="modal fade" id="signup" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static"
                                             ...
                                             <div class="my-3 imgwidth pt-5">
                                                <div class="row">
                                                   ...
                                                   <div class="col-md-5 pt-3">
                                                      <img src="assets/img/qr-code.png" alt="QR-Code LetsFame"
	...
	<!-- main -->
	<main class="ads pt-lg-5 pt-5 mt-04">
		<!--<a href="#enquire"><section class="community-banner2">
			<div class="container">
				<div class="row">
					<div class="col-lg-5 py-5 align-self-center">
						<div class="py-5 my-lg-5">
							<img src="assets/img/loader.webp" alt="img" class="img-fluid w-15">
							<h1 class="text-white pt-4 pb-2">LetsFAME Community Event</h1>
							<p class="text-white text-justfy mb-4">We are excited to announce a special event coming up in our <b>LetsFAME Community Event</b> ! This event promises to be a wonderful opportunity for everyone to come together, have fun, and strengthen our community bonds.</p>
							<a class="btn btn-warning ff-500 px-5 py-2 rounded-pill" href="#enquire">Join With Us</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class=""> 
					<div class="row">
						<div class="col-lg-6 offset-lg-3 align-self-center">
							...
							<div class="bg-bor-radius-shadow">
								<form class="ads-form" method="POST" action="mail-community.php">
									<div class="pb-04">
									...
									<div class="pb-04">
										...
										<input type="text" name="phone" class="form-control" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  required>									
									</div>
									<div class="pb-04">
 ...
 <select id="profession" name="profession" required class="form-control myselect">
 <option></option>
        <?php
        $designations = [
            "Actor",
        ...
        ?>
									...
									<div class="pb-04">
										<label class="form-label">Letsfame Profile link (If you have an account with us)</label>
										<input type="text" name="link" class="form-control">									
									</div>
									<div class="pb-04">
											<div class="g-recaptcha" data-sitekey="6LfX6GMqAAAAAGYDD2MYa9oHhOZEuVrUxnZSE6I9"></div>
									</div>
									<div> 
										<button type="submit" name="submit" class="form-control text-center btn btn-warning rounded-pill ff-500">Submit</button>
									</div>
		...
		<section class="py-lg-3 pt-0 pb-4">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<p>If any queries contact <a href="mailto:contact@letsfame.com" class="ff-500 ahover">contact@letsfame.com</a></p>
					</div>
				</div>
			</div>
		</section>
...
<script>
        function validateMobileNumber() {
            ...
            if (mobileNumber.length < 10) {
                errorMessage.textContent = 'Mobile number must be at least 10 digits long.';
                mobileInput.setCustomValidity('Invalid field.');
            } else {
  ...
  <script>
        ...
        window.onload = function() {
            ...
            formFields.forEach(field => {
                field.addEventListener('copy', disableCopyPaste);
                field.addEventListener('paste', disableCopyPaste);
            });
        }
    </script>
