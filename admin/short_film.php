                    ...
                    <div class="col-md-5 align-self-center">
                        <div class="row">
                            ...
                            <div class="col-md-11 align-self-center">
                                <span class="text-themecolor">Short Film Contest
</span>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card"> 
                            <div class="card-body">
                                <div class="pb-3">
                                    <h5 class="modal-title text-themecolor">Short Film Contest
 Listing</h5>
                                </div>  
...
$sql="DELETE FROM short_filem  WHERE id='$id'";
...
<div class="popup popup--icon -success js_success-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
     ...
     <?php echo "<script>setTimeout(\"location.href = 'short_film.php';\",1500);</script>"; ?>
    </p>
  </div>
</div>
<?php  }  
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="short_film.php"><button class="button button--error" data-for="js_error-popup">Close</button></a>
    </p>
  </div>
</div>  
<?php }
                                    ...
                                    <table id="example" class="display" style="width:100%">
                                        <thead class="text-center table-bg-info">
                                            <tr>
                                                ...
                                                <th>Duration </th>
                                                <th>Directed By </th>
                                                <th>Cast & Crew Details </th>                                               
                                                <th>Letsfame Profile link</th>   
												<th>Short film drive link / youtube link </th>
                                                <th>Check Agree </th>
                                       ...
                                       <tbody>
										<?php $i=1;
										$sql = "SELECT * FROM short_filem ORDER BY id DESC";
                                        ...
                                        <tr>
                                            ...
                                            <td><?php  echo $row['shortfilm']; ?></td>                                            
                                            <td><?php  echo $row['duration']; ?></td>                                            
                                            <td><?php  echo $row['directed']; ?></td>                                            
                                            <td><?php  echo $row['yourmessage']; ?></td>                                            
                                            <td><?php  echo $row['link']; ?></td>                                            
                                            <td><?php  echo $row['youtubelink']; ?></td>                                            
                                            <td><?php  echo $row['checkagree']; ?></td>                                            
                                            <td><?php  echo $row['datetime']; ?></td>                                            
                                                                  
                                            <td style="white-space: nowrap;">                                              
                                                <a href="short_film.php?id=<?php echo $row['id']?>" ><button type="button" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash"></i></button></a>
