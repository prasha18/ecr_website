                                        ...
                                        <div class="col-lg-12 card-body pt-0">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 pt-3">
                                                    ...
                                                    <input type="text" name="fullname" oninput="setName()" id="name" placeholder="Enter Name"
                                                        class="form-control" required>
                                                </div>
                                                <!-- <div class="col-md-6 pt-3">
                                    <h4 class="card-title">Profession <span style="color:red;">*</span></h4>
                                        <select id="profession" name="profession" class="select2 form-control">
                                            <option value="">Select Profession</option>
                                          // <?php
                                          // $response = professionapiCallFunction($data);
                                          // if (isset($response['data']) && is_array($response['data'])) { 
                                          // foreach ($response['data'] as $professionlist) { ?>
                                                // <option value="<?php echo htmlspecialchars($professionlist['name']); ?>">
                                                    // <?php echo htmlspecialchars($professionlist['name']); ?>
                                                // </option>
                                            // } } else { ?>
                                        ...
                                        //  }// ?>
                                                ...
                                                <div class="col-md-6 pt-3">
                                                    ...
                                                    <input type="file" name="profile_img"  id="profile_img" class="form-control"
                                                        placeholder="Enter Profession" onchange="validateFileSize('profile_img', 500)" accept="image/*" required>
                                                ...
                                                <div class="col-md-6 pt-3">
                                                    ...
                                                    <input type="file" name="banner_img"  id="banner_img" class="form-control" accept="image/*"  onchange="validateFileSize('banner_img', 500)" required>
                                                    <p class="text-muted mb-0"><span class="text-danger">*</span>Image
                                                        must be 500kb.</p>
                                                </div>
                                                ...
                                                <div class="col-md-4 pt-3">
                                                    ...
                                                    <input type="text"  id="instagram-name" name="insname"
                                                        placeholder="Enter Instagram Name " class="form-control" required>
                                                </div>
                                                <!--<div class="col-md-3 pt-3">-->
                                                <!--                            <h4 class="card-title">Instagram Url</h4> -->
                                                <!--                            <input type="text" name="insurl" placeholder="Enter Instagram Url " class="form-control" required>-->
                                                <!--                        </div>-->
                                                <div class="col-md-4 pt-3">
                                                ...
                                                <h5 class="modal-title text-themecolor pt-3">Social Media - Twitter
                                                </h5>
                                                ...
                                                <div class="col-md-4 pt-3">
                                                    ...
                                                    <input type="text" id="twitter-name" name="facename" placeholder="Enter Twitter Name "
                                                        class="form-control" required>
                                                </div>
                                                <!--<div class="col-md-3 pt-3">-->
                                                <!--                            <h4 class="card-title">Twitter Url</h4> -->
                                                <!--                            <input type="text" name="faceurl" placeholder="Enter Twitter Url " class="form-control" required>-->
                                                <!--                        </div>-->
                                                <div class="col-md-4 pt-3">
                                                ...
                                                <div class="col-md-4 pt-3">
                                                    ...
                                                    <input type="text" id="youtube-name" name="youname" placeholder="Enter Youtube Name "
                                                        class="form-control" required>
                                                </div>
                                                <!--<div class="col-md-3 pt-3">-->
                                                <!--                            <h4 class="card-title">Youtube Url</h4> -->
                                                <!--                            <input type="text" name="youurl" placeholder="Enter Youtube Url " class="form-control" required>-->
                                                <!--                        </div>-->
                                                <div class="col-md-4 pt-3">
                                                ...
                                                <h5 class="modal-title text-themecolor pt-3">Portfolio </h5>
                                                <div class="col-md-6 pt-3">
                                                ...
                                                <div class="col-md-6 pt-3">
                                                    ...
                                                    <div id="VideoContainer">
                                                        <?php
                                                        $sql = "SELECT * FROM book_artist_video WHERE bookid='0'";
                                                        $result = $connect->query($sql);
                                ...
                                <div class="row">
                                    <div class="col-md-12 pt-3">
                                        ...
                                        <input type="text" name="vidname" id="vidname" placeholder="Enter Name"
                                            class="form-control" required>
                                        <input type="hidden" name="bookid" id="bookid" value="0" class="form-control"
                                            required>
    ...
    <script>
        ...
        async function handleFileInput(event) {
            ...
            try {
                ...
                fetchUpdatedVideos(bookidValue);
        ...
        function fetchUpdatedVideos(bookidValue) {
            $.ajax({
                url: 'fetch_videos.php', // PHP script to fetch updated videos
                type: 'GET',
                data: { id: 'bookidValue' }, // Pass the bookid value in the request if necessary
                success: function (response) {
