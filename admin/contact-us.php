                    ...
                    <div class="col-md-5 align-self-center">
                        <div class="row">
                            ...
                            <div class="col-md-11 align-self-center">
                                <span class="text-themecolor">Contact us</span>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card"> 
                            <div class="card-body">
                                <div class="pb-3">
                                    <h5 class="modal-title text-themecolor">Contact us Listing</h5>
                                </div>  
...
<div class="popup popup--icon -success js_success-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
     ...
     <?php echo "<script>setTimeout(\"location.href = 'contact-us.php';\",1500);</script>"; ?>
    </p>
  </div>
</div>
<?php  }  
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="contact-us.php"><button class="button button--error" data-for="js_error-popup">Close</button></a>
    </p>
  </div>
</div>  
<?php }
...
<td><?php  echo $row['datetime']; ?></td>											
                                            <td style="white-space: nowrap;">                                              
                                                <a href="contact-us.php?id=<?php echo $row['id']?>" ><button type="button" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure to delete this record?')"><i class="fa fa-trash"></i></button></a>
